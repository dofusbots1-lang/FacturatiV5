...
export default function Template5Premium({ data, type, includeSignature = false }: TemplateProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-[#0a1f44] text-white"
      ...
      >
        <div className="p-6 flex items-center justify-between">
          ...
          <div className="flex-1 text-center">
            ...
            <h2 className="text-xl font-semibold mt-2 uppercase tracking-wide">{title}</h2>
          </div>
      ...
      <div style={{ display: 'table-row-group' }}>
        ...
        <div className="p-6 border-b border-[#0a1f44]">
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-gray-50 p-4 rounded border border-[#0a1f44]">
        ...
        <div className="p-6">
          <div className="flex justify-between">
            ...
            <div className="w-80 bg-white rounded border border-[#0a1f44] p-4 shadow-sm">
              <p className="text-sm font-bold pt-2 text-center text-[#0a1f44] pb-2 border-b border-[#0a1f44]">
                Arrêtée le présent {type === 'invoice' ? 'facture' : 'devis'} à la somme de :
              </p>
              <p className="text-sm pt-2 text-[#0a1f44] font-bold">• {data.totalInWords}</p>
            </div>
